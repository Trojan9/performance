...
for i in range(height): #Rows
    for j in range(width): #Columns
       if j==0:
           ...
           myCanvas.create_text(5, 5, text = "KPL1", anchor = "nw")
       elif j==1:
...
for i in range(height): #Rows
    for j in range(width): #Columns
       if j==0:
           myCanvas.create_rectangle(0, 0, 85,45,
            outline="#f50", fill="yellow")
           myCanvas.create_text(5, 5, text = "KPL2", anchor = "nw")
       elif j==1:
         create_circle(110, 25, 20, myCanvas)
       elif j==2:
         create_circle(185, 25, 20, myCanvas) 
...
for i in range(height): #Rows
    for j in range(width): #Columns
       if j==0:
           myCanvas.create_rectangle(0, 0, 85,45,
            outline="#f50", fill="yellow")
           myCanvas.create_text(5, 5, text = "KPL3", anchor = "nw")
       elif j==1:
         create_circle(110, 25, 20, myCanvas)
       elif j==2:
         create_circle(185, 25, 20, myCanvas) 
...
for i in range(height): #Rows
    for j in range(width): #Columns
       if j==0:
            myCanvas.create_rectangle(0, 0, 85,45,
            outline="#f50", fill="yellow") 
            myCanvas.create_text(5, 5, text = "KPL4", anchor = "nw")
       elif j==1:
         create_circle(110, 25, 20, myCanvas)
       elif j==2:
         create_circle(185, 25, 20, myCanvas) 
